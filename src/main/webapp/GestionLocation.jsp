...
<div class="container mt-5">
    <div class="page-header">
        ...
        <p>Gérez vos contrats de location en toute simplicité</p>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">Liste des locations</h2>
                <a href="/location/add" class="btn btn-success">
                    <i class="fa fa-plus me-2"></i> Ajouter une location
                </a>
            </div>

            <div class="search-container">
                <i class="fas fa-search"></i>
                <input type="text" id="searchInput" class="form-control search-input" placeholder="Rechercher une location...">
            </div>
                ...
                <div class="table-container">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            %>
                            <tr>
                                <td><%= loc.getCodeLocation() %></td>
                                <td>
                                    <span class="badge-client">
                                        <i class="fas fa-user"></i> <%= loc.getClient().getNom() %> <%= loc.getClient().getPrenom() %>
                                    </span>
                                </td>
                                <td>
                                    <span class="badge-voiture">
                                        <i class="fas fa-car"></i> <%= loc.getVoiture().getMarque() %> <%= loc.getVoiture().getModele() %>
                                    </span>
                                </td>
                                <td>
                                    <span class="badge-date">
                                        <i class="fas fa-calendar-alt me-1"></i> <%= dateFormat.format(loc.getDate_deb()) %>
                                    </span>
                                </td>
                                <td>
                                    <span class="badge-date">
                                        <i class="fas fa-calendar-alt me-1"></i> <%= dateFormat.format(loc.getDate_fin()) %>
                                    </span>
                                </td>
                                <td>
                                    <a href="/location/updating?codeLoc=<%= loc.getCodeLocation() %>" class="btn btn-primary btn-sm">
                                        <i class="fa fa-edit"></i> Modifier
                                    </a>
                                    <a href="/location/delete?codeLoc=<%= loc.getCodeLocation() %>" class="btn btn-danger btn-sm"
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="empty-state">
                                        ...
                                        <h3 class="empty-title">Aucune location trouvée</h3>
                                        <p class="empty-desc">Commencez par ajouter une nouvelle location</p>
                    ...
                    <div class="location-card">
                        <div class="location-header">
                            ...
                            <div class="location-info">
                                <h3 class="location-name">Location #<%= loc.getCodeLocation() %></h3>
                                <p class="location-client">
                        ...
                        <div class="location-details">
                            <div class="location-detail-row">
                                <div class="location-detail-item">
                                    ...
                                    <span class="detail-value"><%= dateFormat.format(loc.getDate_deb()) %></span>
                                </div>
                                <div class="location-detail-item">
                                    <span class="detail-label">Date fin</span>
                                    <span class="detail-value"><%= dateFormat.format(loc.getDate_fin()) %></span>
                                </div>
                            </div>
                            <div class="location-detail-item mb-2">
                        ...
                        <div class="location-actions">
                            <a href="/location/updating?codeLoc=<%= loc.getCodeLocation() %>" class="action-btn edit">
                                <i class="fa fa-edit me-2"></i> Modifier
                            </a>
                            <a href="/location/delete?codeLoc=<%= loc.getCodeLocation() %>" class="action-btn delete"
                               onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette location ?')">
