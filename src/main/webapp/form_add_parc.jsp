...
<div class="container mt-5">
    <div class="page-header">
        ...
        <p>Enregistrez un nouveau parc dans votre base de données</p>
    </div>
    ...
    <div class="progress-container">
        <div class="progress-steps">
            ...
            <div class="step active">
                ...
                <div class="step-label">Informations parc</div>
            </div>
            <div class="step">
                <div class="step-icon"><i class="fas fa-check"></i></div>
    ...
    <div class="form-card">
        ...
        <div class="form-body">
            <div class="form-tips">
                <h5><i class="fas fa-lightbulb"></i> Conseils pour l'ajout d'un parc</h5>
                <ul>
                    <li>Assurez-vous que le libellé est unique et descriptif</li>
                    <li>La localisation doit être précise pour faciliter la navigation</li>
                    <li>La capacité doit refléter le nombre réel de places disponibles</li>
                </ul>
            </div>

            <form action="/parc/save" method="post" id="addParcForm">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-2"></i> Ajouter Parc
                    </button>
                </div>
            </form>
        </div>
...
<script>
    ...
    (function() {
        ...
        const forms = document.querySelectorAll('#addParcForm');
