...
<div class="container mt-5">
    ...
    <div class="page-header">
        ...
        <p>Modifiez les informations du client en toute simplicité</p>
    </div>
    ...
    <div class="form-card">
        <div class="form-header text-center">
            ...
            <p class="text-muted mb-0">Client #<%= client.getCode_client() %></p>
        </div>
        <div class="form-body">
            <form action="/client/update?id=<%=client.getCode_client()%>" method="post" id="updateClientForm">
                <div class="form-section">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-4">
                                ...
                                <input type="text" id="num_cin" class="form-control" placeholder="Entrez votre CIN" name="num_cin"
                                       value="<%=client.getNcin()%>" required pattern="[A-Za-z0-9]+" minlength="4">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-4">
                                ...
                                <input type="text" id="num_permis" class="form-control" placeholder="Entrez votre numéro permis"
                                       name="num_permis" value="<%=client.getNum_permis()%>" required pattern="[A-Za-z0-9]+" minlength="4">
                    ...
                    <div class="form-floating mb-4">
                        ...
                        <input type="number" id="age" class="form-control" placeholder="Entrez votre age" name="age"
                               value="<%=client.getAge()%>" required min="18" max="120">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-4">
                                ...
                                <input type="tel" id="tel" class="form-control" placeholder="Entrez votre téléphone" name="tel"
                                       value="<%=client.getTel()%>" required pattern="[0-9]{8,12}">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-2"></i> Mettre à jour Client
                    </button>
                </div>
            </form>
        </div>
...
<script>
    ...
    (function() {
        ...
        const forms = document.querySelectorAll('#updateClientForm');
