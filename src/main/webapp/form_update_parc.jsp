...
<div class="container mt-5">
    <div class="page-header">
        <h1>Mettre à jour un parc</h1>
        <p>Modifiez les informations du parc en toute simplicité</p>
    </div>

    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/"><i class="fas fa-home"></i> Accueil</a></li>
            <li class="breadcrumb-item"><a href="/parc"><i class="fas fa-warehouse"></i> Parcs</a></li>
            <li class="breadcrumb-item active" aria-current="page">Mise à jour parc #<%= parc.getNum_parc() %></li>
        </ol>
    </nav>
    ...
    <div class="form-card">
        <div class="form-header text-center">
            ...
            <h2><%= parc.getLibelle() %></h2>
            <p class="text-muted mb-0">Parc #<%= parc.getNum_parc() %></p>
        </div>
        <div class="form-body">
            <form action="/parc/update?id=<%=parc.getNum_parc()%>" method="post" id="updateParcForm">
                <div class="form-section">
                    ...
                    <div class="form-floating mb-4">
                        ...
                        <input type="text" id="libelle" class="form-control" placeholder="Entrez libellé du parc" name="libelle"
                               required value="<%=parc.getLibelle()%>">
                        <label for="libelle">Libellé</label>
                        <div class="invalid-feedback">Veuillez entrer un libellé pour le parc.</div>
                    </div>
                </div>

                <div class="form-section">
                    <div class="section-title">
                        <i class="fas fa-map-marker-alt"></i> Emplacement et capacité
                    </div>
                    <div class="form-floating mb-4">
                        <i class="fa-solid fa-location-dot"></i>
                        <input type="text" id="localisation" class="form-control" placeholder="Entrez localisation du parc" name="localisation"
                               required value="<%=parc.getLocalisation()%>">
                        <label for="localisation">Localisation</label>
                        <div class="invalid-feedback">Veuillez entrer une localisation pour le parc.</div>
                    </div>
                    <div class="form-floating mb-4">
                        <i class="fa-solid fa-car-side"></i>
                        <input type="number" id="capacite" class="form-control" placeholder="Entrez capacité du parc"
                               name="capacite" required min="1" value="<%=parc.getCapacite()%>">
                        <label for="capacite">Capacité</label>
                        <div class="invalid-feedback">Veuillez entrer une capacité valide (minimum 1).</div>
                    </div>
                </div>

                <div class="form-actions">
                    <a href="/parc" class="btn btn-outline-primary">
                        <i class="fas fa-arrow-left me-2"></i> Annuler
                    </a>
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-2"></i> Mettre à jour Parc
                    </button>
                </div>
            </form>
        </div>
...
<script>
    ...
    (function() {
        ...
        const forms = document.querySelectorAll('#updateParcForm');
