    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="/voiture/add" class="btn btn-success">
                    <i class="fa fa-plus me-2"></i> Ajouter un véhicule
                </a>
            </div>

            <div class="search-container">
                <i class="fas fa-search"></i>
                <input type="text" id="searchInput" class="form-control search-input" placeholder="Rechercher un véhicule...">
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge-km">
                                        <i class="fas fa-tachometer-alt me-1"></i> <%= v.getKilometrage() %> km
                                    </span>
                                </td>
                                <td>
                                    <span class="badge-parc">
                                        <i class="fas fa-warehouse"></i> <%= v.getParc().getLibelle() %>
                                    </span>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="empty-state">
                                        ...
                                        <p class="empty-desc">Commencez par ajouter un nouveau véhicule</p>
                    ...
                    <div class="voiture-card">
                        <div class="voiture-header">
                            ...
                            <div class="voiture-info">
                                <h3 class="voiture-name"><%= v.getMarque() %> <%= v.getModele() %></h3>
                                <p class="voiture-matricule">
                        ...
                        <div class="voiture-details">
                            <div class="voiture-detail-row">
                                <div class="voiture-detail-item">
                                    <span class="detail-label">ID Véhicule</span>
                                    <span class="detail-value">#<%= v.getCode_voiture() %></span>
                                </div>
                                <div class="voiture-detail-item">
                                    <span class="detail-label">Kilométrage</span>
                                    <span class="detail-value"><%= v.getKilometrage() %> km</span>
                                </div>
                            </div>
                            <div class="voiture-detail-item mb-2">
                                <span class="detail-label">Parc</span>
                        ...
                        <div class="voiture-actions">
                            <a href="/voiture/updating?id=<%= v.getCode_voiture() %>" class="action-btn edit">
                                <i class="fa fa-edit me-2"></i> Modifier
                            </a>
                            <a href="/voiture/delete?id=<%= v.getCode_voiture() %>" class="action-btn delete"
                               onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce véhicule ?')">
