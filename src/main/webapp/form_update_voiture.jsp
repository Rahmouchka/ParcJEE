...
<div class="container mt-5">
    <div class="page-header">
        ...
        <p>Modifiez les informations du véhicule en toute simplicité</p>
    </div>

    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/"><i class="fas fa-home"></i> Accueil</a></li>
            <li class="breadcrumb-item"><a href="/voiture"><i class="fas fa-car"></i> Voitures</a></li>
            <li class="breadcrumb-item active" aria-current="page">Mise à jour véhicule #<%= v.getCode_voiture() %></li>
        </ol>
    </nav>
    ...
    <div class="form-card">
        <div class="form-header text-center">
            ...
            <p class="text-muted mb-0">Matricule: <%= v.getMatricule() %></p>
        </div>
        <div class="form-body">
            <form action="/voiture/update?id=<%=v.getCode_voiture()%>" method="post" id="updateVoitureForm">
                <div class="form-section">
                    ...
                    <div class="form-floating mb-4">
                        ...
                        <input type="text" id="matricule" class="form-control" placeholder="Entrez matricule de la voiture" name="matricule"
                               required pattern="[A-Za-z0-9\s-]+" minlength="4" value="<%=v.getMatricule()%>">
                ...
                <div class="form-section">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-4">
                                ...
                                <input type="text" id="marque" class="form-control" placeholder="Entrez marque de la voiture"
                                       name="marque" required value="<%=v.getMarque()%>">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-4">
                                ...
                                <input type="text" id="modele" class="form-control" placeholder="Entrez modèle de la voiture"
                                       name="modele" required value="<%=v.getModele()%>">
                    ...
                    <div class="form-floating mb-4">
                        ...
                        <input type="number" step="0.1" id="kilometrage" class="form-control" placeholder="Entrez kilometrage de la voiture"
                               name="kilometrage" required min="0" value="<%=v.getKilometrage()%>">
                        ...
                        <select name="parc" id="parc" class="form-select" required>
                            <%
                                if (parcs != null) {
                                    for (Parc p : parcs) {
                            %>
                            <option value="<%=p.getNum_parc()%>" <%= p.getNum_parc() == v.getParc().getNum_parc() ? "selected" : "" %>>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-2"></i> Mettre à jour Véhicule
                    </button>
                </div>
            </form>
        </div>
...
<script>
    ...
    (function() {
        ...
        const forms = document.querySelectorAll('#updateVoitureForm');
